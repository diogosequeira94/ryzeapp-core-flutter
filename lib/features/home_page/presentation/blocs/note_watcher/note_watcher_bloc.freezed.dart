...
// ignore: unused_element
  _WatchUncompletedStarted watchUncompletedStated() {
...
mixin _$NoteWatcherEvent {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult watchUncompletedStated(),
    @required
        TResult notesReceived(Either<NoteFailure, List<Note>> failureOrNotes),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult watchAllStarted(),
    TResult watchUncompletedStated(),
    TResult notesReceived(Either<NoteFailure, List<Note>> failureOrNotes),
  ...
  TResult map<TResult extends Object>({
    ...
    @required TResult watchUncompletedStated(_WatchUncompletedStarted value),
    @required TResult notesReceived(_NotesReceived value),
  });
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object>({
    TResult watchAllStarted(_WatchAllStarted value),
    TResult watchUncompletedStated(_WatchUncompletedStarted value),
...
class _$_WatchAllStarted implements _WatchAllStarted {
  ...
  TResult when<TResult extends Object>({
    ...
    assert(watchUncompletedStated != null);
...
class _$_WatchUncompletedStarted implements _WatchUncompletedStarted {
  ...
  @override
  String toString() {
    return 'NoteWatcherEvent.watchUncompletedStated()';
  }
  ...
  TResult maybeWhen<TResult extends Object>({
    ...
    assert(orElse != null);
    if (watchUncompletedStated != null) {
      return watchUncompletedStated();
    }
    return orElse();
  }
  ...
  TResult map<TResult extends Object>({
    ...
    assert(watchUncompletedStated != null);
    assert(notesReceived != null);
    return watchUncompletedStated(this);
  }
  ...
  $Res call({
    ...
    return _then(_NotesReceived(
      failureOrNotes == freezed
          ...
          : failureOrNotes as Either<NoteFailure, List<Note>>,
    ));
  }
}
...
mixin _$NoteWatcherState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult loadSuccess(List<Note> notes),
  ...
  TResult maybeWhen<TResult extends Object>({
    ...
    TResult loadSuccess(List<Note> notes),
