...
mixin _$NoteWatcherEvent {
  ...
  Result when<Result extends Object>({
    ...
    @required Result watchUncompletedStated(),
    @required
        Result notesReceived(Either<NoteFailure, List<Note>> failureOrNotes),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result watchAllStarted(),
    Result watchUncompletedStated(),
    Result notesReceived(Either<NoteFailure, List<Note>> failureOrNotes),
  ...
  Result map<Result extends Object>({
    ...
    @required Result watchUncompletedStated(_WatchUncompletedStarted value),
    @required Result notesReceived(_NotesReceived value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    Result watchAllStarted(_WatchAllStarted value),
    Result watchUncompletedStated(_WatchUncompletedStarted value),
...
mixin _$NoteWatcherState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result loadSuccess(List<Note> notes),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result loadSuccess(List<Note> notes),
