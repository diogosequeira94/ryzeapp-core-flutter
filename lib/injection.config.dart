...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i4.FirebaseStorage>(
      () => firebaseInjectableModule.firebaseStorage);
  gh.lazySingleton<_i5.Firestore>(
      () => firebaseInjectableModule.firebaseFireStore);
  gh.lazySingleton<_i6.GoogleSignIn>(
      () => firebaseInjectableModule.googleSignIn);
  gh.lazySingleton<_i7.IAuthFacade>(() => _i8.FirebaseAuthFacade(
      get<_i3.FirebaseAuth>(), get<_i5.Firestore>(), get<_i6.GoogleSignIn>()));
  gh.lazySingleton<_i9.IJobPostRepository>(() =>
      _i10.JobRepository(get<_i5.Firestore>(), get<_i4.FirebaseStorage>()));
  gh.lazySingleton<_i11.INoteRepository>(
      () => _i12.NoteRepository(get<_i5.Firestore>()));
